...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'GameOne',
          path: '/gameOne',
          builder: (context, params) => GameOneWidget(),
        ),
        FFRoute(
          name: 'PlayGame',
          path: '/playGame',
          builder: (context, params) => PlayGameWidget(
        ...
        FFRoute(
          name: 'QuizOne',
          path: '/quizOne',
          builder: (context, params) => QuizOneWidget(),
        ),
        FFRoute(
          name: 'DoQuiz',
          path: '/doQuiz',
        ...
        FFRoute(
          ...
          path: '/selfStudy',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'SelfStudy')
              : SelfStudyWidget(),
        ),
        FFRoute(
          name: 'Geometry',
          path: '/geometry',
          builder: (context, params) => GeometryWidget(),
        ),
        FFRoute(
          name: 'Algebra',
          path: '/algebra',
          builder: (context, params) => AlgebraWidget(),
        ),
        FFRoute(
          name: 'Basics',
          path: '/basics',
          builder: (context, params) => BasicsWidget(),
        ),
        FFRoute(
          name: 'TopicCards',
          path: '/topicCards',
          builder: (context, params) => TopicCardsWidget(
