...
class SelfStudyWidget extends StatefulWidget {
  const SelfStudyWidget({super.key});

  @override
  State<SelfStudyWidget> createState() => _SelfStudyWidgetState();
}
