...
class CopyrightLicenseWidget extends StatefulWidget {
  const CopyrightLicenseWidget({super.key});

  @override
  State<CopyrightLicenseWidget> createState() => _CopyrightLicenseWidgetState();
}
